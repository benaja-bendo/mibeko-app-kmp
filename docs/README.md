...
> Statut : à jour au 2 août 2026 · index de la documentation technique de l'application mobile Compose Multiplatform (Android + iOS).
...
| [migration-agp10.md](./migration-agp10.md) | Migration vers la structure à deux modules `:composeApp`/`:androidApp`, imposée par AGP 9/10. |
